...
export var DrawerContent = memo(function (props) {
    ...
    return (_jsx(Portal, { children: _jsxs("div", { className: classNames(cls.drawer, className, theme), children: [_jsx(Overlay, { onClick: close }), _jsx(Spring.a.div, __assign({ className: cls.sheet, style: { display: display, bottom: "calc(-100vh + ".concat(height - 100, "px)"), y: y } }, bind(), { children: children }))] }) }));
});
// wrapper that load libraries async.
